...
public class Main {
    public static void main(String[] args) {
		...
		//	New users
		User user1 = new User(1L, "Ivan@mail.ru - Jdbc");
		User user2 = new User(2L, "Vano@mail.ru - JdbcTemplate");
    ...
    private static void createTable() {
        ...
        try (Connection connection = dataSource.getConnection();
            ...
            statement.executeUpdate("CREATE TABLE IF NOT EXISTS users (id BIGSERIAL PRIMARY KEY, email VARCHAR(50));");
